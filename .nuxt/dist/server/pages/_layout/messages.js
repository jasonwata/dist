...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/_layout/messages.vue?vue&type=template&id=064ef19f&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('luma-messages-page',{attrs:{"title":_vm.title,"container-class":_vm.containerClass,"navbar-container-class":_vm.navbarContainerClass}})}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/_layout/messages.vue?vue&type=template&id=064ef19f&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/_layout/messages.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var messagesvue_type_script_lang_js_ = ({components:{LumaMessagesPage:external_vue_luma_["LumaMessagesPage"]},extends:Page["a" /* default */],data:function data(){return{title:this.$t('Messages')};},computed:{subLayout:function subLayout(){return true;},subLayoutHasScrollingRegion:function subLayoutHasScrollingRegion(){return false;},subLayoutDrawer:function subLayoutDrawer(){return external_vue_luma_["MessagesSidebar"];},subLayoutDrawerAlign:function subLayoutDrawerAlign(){return'end';},subLayoutDrawerId:function subLayoutDrawerId(){return'messages-drawer';}},asyncData:function asyncData(_ref){return asyncToGenerator_default()(/*#__PURE__*/regenerator_default.a.mark(function _callee(){var app;return regenerator_default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:app=_ref.app;return _context.abrupt("return",{title:app.i18n.t('Messages')});case 2:case"end":return _context.stop();}}},_callee);}))();}});
// CONCATENATED MODULE: ./pages/_layout/messages.vue?vue&type=script&lang=js&
 /* harmony default export */ var _layout_messagesvue_type_script_lang_js_ = (messagesvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(8);

// CONCATENATED MODULE: ./pages/_layout/messages.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  _layout_messagesvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
