...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/_layout/student-skill-result.vue?vue&type=template&id=fffc1e5c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('luma-student-skill-result-page',{attrs:{"title":_vm.title,"breadcrumb":_vm.breadcrumb,"container-class":_vm.containerClass}})}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/_layout/student-skill-result.vue?vue&type=template&id=fffc1e5c&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/_layout/student-skill-result.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var student_skill_resultvue_type_script_lang_js_ = ({components:{LumaStudentSkillResultPage:external_vue_luma_["LumaStudentSkillResultPage"]},extends:Page["a" /* default */],data:function data(){return{title:this.$t('Path Details')};},computed:{headerClass:function headerClass(){return'mb-0';}},asyncData:function asyncData(_ref){return asyncToGenerator_default()(/*#__PURE__*/regenerator_default.a.mark(function _callee(){var app;return regenerator_default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:app=_ref.app;return _context.abrupt("return",{title:app.i18n.t('Path Details')});case 2:case"end":return _context.stop();}}},_callee);}))();}});
// CONCATENATED MODULE: ./pages/_layout/student-skill-result.vue?vue&type=script&lang=js&
 /* harmony default export */ var _layout_student_skill_resultvue_type_script_lang_js_ = (student_skill_resultvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(8);

// CONCATENATED MODULE: ./pages/_layout/student-skill-result.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  _layout_student_skill_resultvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var student_skill_result = __webpack_exports__["default"] = (component.exports);

/***/ })

};;
//# sourceMappingURL=student-skill-result.js.map