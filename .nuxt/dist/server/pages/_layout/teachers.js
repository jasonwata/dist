...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/_layout/teachers.vue?vue&type=template&id=81ae0dac&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('luma-teachers-page',{attrs:{"title":_vm.title,"container-class":_vm.containerClass,"results-heading-sidebar-toggle":_vm.resultsHeadingSidebarToggle}})}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/_layout/teachers.vue?vue&type=template&id=81ae0dac&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/_layout/teachers.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var teachersvue_type_script_lang_js_ = ({components:{LumaTeachersPage:external_vue_luma_["LumaTeachersPage"]},extends:Page["a" /* default */],data:function data(){return{title:this.$t('Browse Teachers')};},computed:{guest:function guest(){return true;},subLayout:function subLayout(){return this.$root.layoutName==='fixed';},subLayoutDrawer:function subLayoutDrawer(){return this.$root.layoutName==='fixed'?external_vue_luma_["LibrarySidebar"]:external_vue_luma_["LibraryDrawer"];},subLayoutDrawerId:function subLayoutDrawerId(){return'library-drawer';},resultsHeadingSidebarToggle:function resultsHeadingSidebarToggle(){return this.$root.layoutName==='fixed'?'mobile':true;}},asyncData:function asyncData(_ref){return asyncToGenerator_default()(/*#__PURE__*/regenerator_default.a.mark(function _callee(){var app;return regenerator_default.a.wrap(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:app=_ref.app;return _context.abrupt("return",{title:app.i18n.t('Browse Teachers')});case 2:case"end":return _context.stop();}}},_callee);}))();}});
// CONCATENATED MODULE: ./pages/_layout/teachers.vue?vue&type=script&lang=js&
 /* harmony default export */ var _layout_teachersvue_type_script_lang_js_ = (teachersvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(8);

// CONCATENATED MODULE: ./pages/_layout/teachers.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  _layout_teachersvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var teachers = __webpack_exports__["default"] = (component.exports);
